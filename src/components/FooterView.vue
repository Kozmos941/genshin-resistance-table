...
import FLink from '#/Footer/FLink.vue'
...
<template>
  <footer>
    <f-link href="https://github.com/Kozmos941/genshin-resistance-table" icon="github.svg">
    ...
    <f-item v-for="item in items" :key="item.title" :title="item.title" :links="item.links"></f-item>
  </footer>
  <hr>
</template>
